...
Permission is granted to download and use this software for
...
You may not, without prior written permission:
  ...
  - sublicense or sell the software as a standalone product;
  - remove or alter copyright, attribution, or other notices;
  - use the author's name or the product name to imply
    endorsement of another product or service.
